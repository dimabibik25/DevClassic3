namespace Terrasoft.Configuration
{
	...
	public class UsrRealtyServiceSchema : Terrasoft.Core.SourceCodeSchema
	{
		...
		protected override void InitializeProperties() {
			...
			UId = new Guid("0bc6bb3b-3557-4f37-be99-463d2cee5886");
			Name = "UsrRealtyService";
			ParentSchemaUId = new Guid("50e3acc0-26fc-4237-a095-849a1d534bd3");
			CreatedInPackageId = new Guid("e468ff55-4e06-4175-b1a2-19853dbdbf7c");
			ZipBody = new byte[] { 31,139,8,0,0,0,0,0,4,0,83,72,44,78,1,34,0,53,238,151,156,7,0,0,0 };
		}
		...
		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			...
			realUIds.Add(new Guid("0bc6bb3b-3557-4f37-be99-463d2cee5886"));
		}

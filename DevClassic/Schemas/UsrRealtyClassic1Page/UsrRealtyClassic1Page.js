define("UsrRealtyClassic1Page", ["ServiceHelper"], function(ServiceHelper) {
	return {
		...
		diff: /**SCHEMA_DIFF*/[
			{
				"operation": "insert",
				"name": "UsrName377bc67e-3db6-4d9c-95d6-5cb354c72163",
				"values": {
					"layout": {
						"colSpan": 24,
						"rowSpan": 1,
			...
			{
				"operation": "insert",
				"name": "FLOAT88ee4266-c67f-4538-a89d-21cc9a4be48d",
				"values": {
					"layout": {
						"colSpan": 24,
						"rowSpan": 1,
			...
			{
				"operation": "insert",
				"name": "FLOATa2323d58-f884-4480-b938-cd8ac393e1e2",
				"values": {
					"layout": {
						"colSpan": 24,
						"rowSpan": 1,
			...
			{
				"operation": "insert",
				"name": "FLOATb552ed89-9b2f-4d9d-99df-115860c481ff",
				"values": {
					"layout": {
						"colSpan": 24,
						"rowSpan": 1,
			...
			{
				"operation": "insert",
				"name": "LOOKUPb4909e00-01a7-4b41-b90a-e3eb572c44d8",
				"values": {
					"layout": {
						"colSpan": 12,
						"rowSpan": 1,
			...
			{
				"operation": "insert",
				"name": "LOOKUP2798db27-7ce9-4749-a530-1d6da9665a1e",
				"values": {
					"layout": {
						"colSpan": 12,
						"rowSpan": 1,
			...
			{
				"operation": "insert",
				"name": "STRING5a400ca7-5a4c-496c-bb62-a962a0fa2644",
				"values": {
					"layout": {
						"colSpan": 12,
						"rowSpan": 1,
					...
					"tip": {
						"content": {
							"bindTo": "Resources.Strings.STRING5a400ca75a4c496cbb62a962a0fa2644Tip"
						}
					}
				},
				"parentName": "Header",
			...
			{
				"operation": "insert",
				"name": "LOOKUP26ab5b93-636e-40f4-b98f-586ab738364a",
				"values": {
					"layout": {
						"colSpan": 12,
						"rowSpan": 1,
